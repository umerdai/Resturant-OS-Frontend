    ...
    <div class="smart-order-assistant">
        ...
        <div class="chat-header">
            <div class="flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="chat-title">Weekly Sales Report</h2>
                    <p class="chat-subtitle">Ask me anything sales report related</p>
                </div>
            </div>
        ...
        <div class="chat-container">
            ...
            <ScrollPanel class="chat-messages">
                ...
                <div v-if="messages.length === 0" class="welcome-message">
                    ...
                    <h3>Welcome! 👋</h3>
                    <p>I'm your Weekly Sales Report Assistant. Ask me about:</p>
                    <div class="suggestion-chips">
                        <Button label="📈 Weekly Report" size="small" outlined @click="userMessage = `give me this week's sales report?`" />
                    </div>
                </div>
