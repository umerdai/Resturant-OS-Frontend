    ...
    <div class="smart-order-assistant">
        ...
        <div class="chat-header">
            <div class="flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="chat-title">Weekly Sales Prediction</h2>
                    <p class="chat-subtitle">Ask me anything about sales prediction weekly</p>
                </div>
            </div>
        ...
        <div class="chat-container">
            ...
            <ScrollPanel class="chat-messages">
                ...
                <div v-if="messages.length === 0" class="welcome-message">
                    ...
                    <h3>Welcome! 👋</h3>
                    <p>I'm your Weekly Sales Prediction Assistant. Ask me about:</p>
                    <div class="suggestion-chips">
                        <Button label="📈 Sales Trends" size="small" outlined @click="userMessage = 'What are the sales trends for this week?'" />
                        <Button label="💰 Best Selling Items" size="small" outlined @click="userMessage = 'Show me the best selling items this week'" />
                        <Button label="📊 Sales by Category" size="small" outlined @click="userMessage = 'What are the sales by category this week?'" />
                    </div>
                </div>
