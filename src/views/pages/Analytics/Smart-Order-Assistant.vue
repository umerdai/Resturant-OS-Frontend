    ...
    <div class="smart-order-assistant">
        ...
        <div class="chat-header">
            <div class="flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="chat-title">Smart Order Assistant</h2>
                    <p class="chat-subtitle">Ask me anything about our menu and combos</p>
                </div>
            </div>
        ...
        <div class="chat-container">
            ...
            <ScrollPanel class="chat-messages">
                ...
                <div v-if="messages.length === 0" class="welcome-message">
                    ...
                    <h3>Welcome! 👋</h3>
                    <p>I'm your Smart Order Assistant. Ask me about:</p>
                    <div class="suggestion-chips">
                        <Button label="🍕 Popular combos" size="small" outlined @click="userMessage = 'What are the popular combos?'" />
                        <Button label="💰 Best deals" size="small" outlined @click="userMessage = 'Show me the best deals'" />
                        <Button label="🌟 Recommendations" size="small" outlined @click="userMessage = 'What do you recommend?'" />
                    </div>
                </div>
