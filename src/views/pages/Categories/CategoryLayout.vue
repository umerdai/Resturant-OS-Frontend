...
const viewCategory = (category) => {
    toast.add({
        ...
        detail: `Viewing details for ${category.name}`,
        life: 3000
    });
    // TODO: Navigate to category details view
...
const manageCategory = (category) => {
    toast.add({
        ...
        detail: `Managing ${category.name}`,
        life: 3000
    });
    // TODO: Navigate to category management view
    // router.push(`/categories/${category.id}/manage`);
};
...
<template>
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold">�️ Category Management</h2>
            ...
            <Card v-for="category in categories" :key="category.id" class="category-card">
                ...
                <template #footer>
                    <div class="flex justify-end gap-2">
                        <Button label="Manage" icon="pi pi-cog" size="small" class="p-button-outlined" @click="manageCategory(category)" />
